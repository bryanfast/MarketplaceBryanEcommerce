...
namespace MarketplaceBryanEcommerce.Server.Migrations
{
    ...
    [Migration("20220725231916_Images")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MarketplaceBryanEcommerce.Shared.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MarketplaceBryanEcommerce.Shared.CartItem", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MarketplaceBryanEcommerce.Shared.Image", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MarketplaceBryanEcommerce.Shared.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MarketplaceBryanEcommerce.Shared.OrderItem", b =>
                {
            ...
            modelBuilder.Entity("MarketplaceBryanEcommerce.Shared.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MarketplaceBryanEcommerce.Shared.Address", b =>
                {
                    b.HasOne("MarketplaceBryanEcommerce.Shared.User", null)
                        .WithOne("Address")
                        .HasForeignKey("MarketplaceBryanEcommerce.Shared.Address", "UserId")
            ...
            modelBuilder.Entity("MarketplaceBryanEcommerce.Shared.Image", b =>
                {
                    b.HasOne("MarketplaceBryanEcommerce.Shared.Product", null)
                        .WithMany("Images")
            ...
            modelBuilder.Entity("MarketplaceBryanEcommerce.Shared.OrderItem", b =>
                {
                    b.HasOne("MarketplaceBryanEcommerce.Shared.Order", "Order")
                        .WithMany("OrderItems")
